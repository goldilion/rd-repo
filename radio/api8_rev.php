...
if(isset($_GET['cat_id']))
	...
	else if(isset($_GET['catkey']))
	{
		...
		ORDER BY radio_name
		";
	} else if (isset($_GET['latest']) || isset($_GET['home']) {
		// to show home or latest for world radio 
		$catkey = $_GET['catkey']; 	

	} /*else if ((isset($_GET['latest']) || isset($_GET['home'])) && isset($GET['catkey'])) {
		// to show home or latest for specific country radio 
