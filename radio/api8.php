...
if(isset($_GET['cat_id']))
	{
		...
		SELECT 
			...
			r.radio_name, 
			IF(radio_image = 'http://d1i6vahw24eb07.cloudfront.net/s0s.gif', 'http://apitv.wakootv.com/radio/img/1.gif', CONCAT('http://apitv.wakootv.com/radio/img/', r.note, '.gif')) AS radio_image,
		...
		SELECT
			...
			CONCAT('http://apitv.wakootv.com/radio/img/', SUBSTRING_INDEX(rg.channel_img,  '/', -1)) AS radio_image,
		...
		SELECT 
			...
			SUBSTRING_INDEX(radio_url, ' ', 1) AS radio_url,
			'' AS radio_frequency,
			IF(radio_image = 'http://d1i6vahw24eb07.cloudfront.net/s0s.gif', 'http://apitv.wakootv.com/radio/img/1.gif', CONCAT('http://apitv.wakootv.com/radio/img/', r.note, '.gif')) AS video_thumbnail_b, 
			IF(radio_image = 'http://d1i6vahw24eb07.cloudfront.net/s0s.gif', 'http://apitv.wakootv.com/radio/img/1.gif', CONCAT('http://apitv.wakootv.com/radio/img/', r.note, '.gif')) AS video_thumbnail_s, 
		...
		SELECT
		    ...
		    rg.channel_source AS radio_url,
		    '' AS radio_frequency,
		    CONCAT('http://apitv.wakootv.com/radio/img/', SUBSTRING_INDEX(rg.channel_img,  '/', -1)) AS video_thumbnail_b,
		    CONCAT('http://apitv.wakootv.com/radio/img/', SUBSTRING_INDEX(rg.channel_img,  '/', -1)) AS video_thumbnail_s,
			FLOOR(RAND()*(259))+7696 AS views,
			'English' AS language_name,
			rg.cat_id AS cid,
			c.category_name AS city_name,
        ...
        else if(isset($_GET['gkey']))
	{
		...
		/*$query = "
		SELECT c.cid, c.category_name, CONCAT('http://108.61.75.183/apirtv/radio/img/logos/', c.category_image) AS category_image
